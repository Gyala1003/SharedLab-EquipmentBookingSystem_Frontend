      ...
      >
        ...
        >
          ...
          <div class="relative flex items-center gap-3">
            <div
              class="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-400 to-cyan-300 text-[#111a3a] shadow-xl shadow-violet-950/30"
            >
          ...
          <div class="relative my-auto max-w-xl py-16">
            ...
            <h1 class="mt-8 text-5xl leading-[1.08] font-bold tracking-[-0.04em] xl:text-6xl">
              ...
              Quản lý thiết bị.<br />
              <span
                class="bg-gradient-to-r from-violet-300 to-cyan-300 bg-clip-text text-transparent"
                >Tối ưu nghiên cứu.</span
              >
            </h1>
            <p class="mt-7 max-w-lg text-base leading-7 text-white/60 xl:text-lg">
              Một nền tảng thống nhất giúp sinh viên, giảng viên và quản lý vận hành tài nguyên
              phòng thí nghiệm hiệu quả hơn mỗi ngày.
            </p>
        ...
        <section class="flex items-center justify-center px-5 py-10 sm:px-10 lg:px-14 xl:px-20">
          <div class="w-full max-w-[460px]">
            ...
            <p class="mt-3 text-sm leading-6 text-slate-500">
              Sử dụng email do quản trị viên cấp để truy cập hệ thống.
            </p>
            ...
            >
              ...
              Tài khoản được quản lý tập trung bởi Admin. Liên hệ quản trị viên nếu bạn chưa được
              cấp tài khoản.
            </div>
          </div>
        </section>
