            ...
            >
              @if (item()!.imageUrl) {
                ...
                <div
                  ...
                  style="background-image:radial-gradient(circle at 25% 20%,#8b5cf6,transparent 30%),radial-gradient(circle at 75% 80%,#06b6d4,transparent 28%)"
                ></div>
                <div
                  class="relative flex h-32 w-32 items-center justify-center rounded-[38px] border border-white/15 bg-white/10 text-white backdrop-blur"
                >
                  <app-icon name="microscope" [size]="62" />
                </div>
              }
