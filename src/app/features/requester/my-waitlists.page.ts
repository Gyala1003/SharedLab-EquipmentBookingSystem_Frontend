...
@Component({
  ...
  template: `
    <section class="space-y-6">
      <app-page-header [title]="'waitlists.title' | t" [subtitle]="'waitlists.subtitle' | t"
      ...
      <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <div class="kpi-card">
          <p class="text-xs font-bold text-slate-400">{{ 'waitlists.waiting' | t }}</p>
          <p class="mt-2 text-3xl font-black text-amber-600">{{ count('Waiting') }}</p>
        </div>
        <div class="kpi-card">
          <p class="text-xs font-bold text-slate-400">{{ 'waitlists.notified' | t }}</p>
          <p class="mt-2 text-3xl font-black text-emerald-600">{{ count('Notified') }}</p>
        </div>
        <div class="kpi-card">
          <p class="text-xs font-bold text-slate-400">{{ 'waitlists.booked' | t }}</p>
          <p class="mt-2 text-3xl font-black text-indigo-600">{{ count('Booked') }}</p>
        </div>
        <div class="kpi-card">
          <p class="text-xs font-bold text-slate-400">{{ 'waitlists.expiredOrCancelled' | t }}</p>
