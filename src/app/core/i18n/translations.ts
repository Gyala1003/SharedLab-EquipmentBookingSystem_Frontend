export const translations: Record<string, { vi: string; en: string }> = {
  ...
  'auth.passwordPolicyHint': { vi: 'Mật khẩu phải dài hơn 8 ký tự, gồm chữ hoa, chữ thường, chữ số và ký tự đặc biệt', en: 'Password must be more than 8 characters, with uppercase, lowercase, number, and special character' },
  'auth.passwordRules.minLength': { vi: 'Hơn 8 ký tự (tối thiểu 9)', en: 'More than 8 characters (min. 9)' },
