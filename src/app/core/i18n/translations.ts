export const translations: Record<string, { vi: string; en: string }> = {
  ...
  'dashboard.topPenalizedUsers': { vi: 'Người dùng có điểm phạt cao', en: 'Users with High Penalty Points' },
  'dashboard.topPenalizedSub': { vi: 'Ưu tiên theo dõi trong kỳ', en: 'Priority monitoring for the period' },
  'dashboard.noPenalizedUsers': { vi: 'Không có người dùng vi phạm trong kỳ.', en: 'No violating users in this period.' },
  'dashboard.mostUsedLabs': { vi: 'Phòng lab dùng nhiều nhất', en: 'Most Used Labs' },
  'dashboard.mostUsedLabsSub': { vi: 'Xếp hạng theo giờ sử dụng thực tế', en: 'Ranked by actual usage hours' },
  'dashboard.mostUsedEquipments': { vi: 'Thiết bị dùng nhiều nhất', en: 'Most Used Equipment' },
  'dashboard.mostUsedEquipmentsSub': { vi: 'Xếp hạng theo giờ sử dụng thực tế', en: 'Ranked by actual usage hours' },
  ...
  'equipments.subtitle': { vi: 'Tìm kiếm, kiểm tra trạng thái và đặt lịch các thiết bị dùng chung trong hệ thống.', en: 'Search, check status and book shared equipment.' },
  ...
  'home.upcomingSubtitle': { vi: 'Các lịch đã được duyệt và chuẩn bị diễn ra', en: 'Approved bookings happening soon' },
  'home.viewAll': { vi: 'Xem tất cả', en: 'View All' },
  'home.noUpcoming': { vi: 'Chưa có booking sắp tới', en: 'No upcoming bookings' },
  'home.noUpcomingSub': { vi: 'Khi booking được duyệt, lịch sẽ xuất hiện ở đây.', en: 'Approved bookings will appear here.' },
  'home.accountHealth': { vi: 'Sức khỏe tài khoản', en: 'Account Health' },
  'home.accountHealthSub': { vi: 'Cập nhật theo điểm phạt hiện tại', en: 'Updated based on current penalties' },
  ...
  'home.latestNotificationsSub': { vi: 'Những cập nhật bạn cần xử lý', en: 'Updates requiring your attention' },
  ...
  'home.waitlistSub': { vi: 'Theo dõi vị trí và thời gian được giữ chỗ', en: 'Track your position and reserved spot' },
  ...
  'checkout.modalSubtitle': { vi: 'Lịch đặt của bạn đã kết thúc. Vui lòng xác nhận hoàn thành sử dụng.', en: 'Your booking has ended. Please confirm checkout.' },
  ...
  'violations.subtitle': { vi: 'Theo dõi các vi phạm liên quan tới booking, tổng điểm phạt và trạng thái hạn chế tài khoản.', en: 'Track booking violations, total penalty points, and account restriction status.' },
  ...
  'violations.noViolationsMsg': { vi: 'Duy trì check-in/check-out đúng giờ và sử dụng tài nguyên đúng hướng dẫn.', en: 'Keep checking in/out on time and follow resource guidelines.' },
  ...
  // Bookings & Waitlists
  'bookings.mySubtitle': { vi: 'Theo dõi toàn bộ yêu cầu, trạng thái duyệt và các lượt sử dụng sắp diễn ra.', en: 'Track all booking requests, approval status, and upcoming usage.' },
  ...
  'waitlists.subtitle': { vi: 'Theo dõi vị trí, thời gian giữ chỗ và tạo booking ngay khi nhận được thông báo.', en: 'Track position, reserved spot duration, and book as soon as notified.' },
  ...
  'waitlists.remainingTime': { vi: 'Thời gian giữ chỗ còn lại', en: 'Reserved Spot Remaining Time' },
  'waitlists.backendNote': { vi: 'Hệ thống giữ lượt tối đa 30 phút từ', en: 'Spot held for max 30 mins from' },
  'waitlists.noWaitlists': { vi: 'Không có lượt hàng chờ', en: 'No waitlist entries' },
  'waitlists.noWaitlistsMsg': { vi: 'Khi khung giờ mong muốn bị chiếm, bạn có thể tham gia hàng chờ từ luồng tạo booking.', en: 'When a desired time slot is busy, join the waitlist from booking flow.' },
  ...
  'notifications.subtitle': { vi: 'Theo dõi booking, hàng chờ, vi phạm, bảo trì và thông báo hệ thống.', en: 'Track bookings, waitlists, violations, maintenance, and system alerts.' },
  'notifications.markAllAsRead': { vi: 'Đánh dấu tất cả đã đọc', en: 'Mark all as read' },
  'notifications.searchPlaceholder': { vi: 'Tìm trong thông báo...', en: 'Search in notifications...' },
  'notifications.allTypes': { vi: 'Tất cả loại', en: 'All types' },
  'notifications.overviewTitle': { vi: 'Tổng quan hộp thư', en: 'Inbox Overview' },
  'notifications.overviewSub': { vi: 'Thông báo chưa đọc sẽ có nền tím nhạt và chấm trạng thái ở bên phải.', en: 'Unread notifications have a light purple background and a status dot.' },
  ...
  'profile.subtitle': { vi: 'Thông tin được đồng bộ từ hệ thống và hiện chỉ hỗ trợ chế độ xem.', en: 'Information synchronized from the system (read-only view).' },
  ...
  'profile.securityNote': { vi: 'Backend hiện chưa có API đổi mật khẩu khi đang đăng nhập. Bạn có thể dùng luồng đặt lại qua email.', en: 'Backend password change API not available while logged in. Use email reset flow.' },
  ...
  'profile.accountInfoSub': { vi: 'Dữ liệu được đồng bộ từ hồ sơ hệ thống', en: 'Data synchronized from system profile' },
  ...
  'profile.activeStatusSub': { vi: 'Quyền sử dụng hệ thống hiện tại', en: 'Current system access rights' },
  'profile.activeStatusDesc': { vi: 'Có thể sử dụng đầy đủ các chức năng theo vai trò được cấp.', en: 'Full access to all features according to assigned role.' },
  'profile.restrictionTitle': { vi: 'Thời hạn hạn chế', en: 'Restriction Period' },
  'profile.restrictionSub': { vi: 'Áp dụng khi tài khoản Restricted', en: 'Applies when account is Restricted' },
  ...
  'maintenances.subtitle': { vi: 'Theo dõi và quản lý kế hoạch bảo trì phòng lab và thiết bị dùng chung.', en: 'Track and manage maintenance plans for shared lab rooms and equipment.' },
