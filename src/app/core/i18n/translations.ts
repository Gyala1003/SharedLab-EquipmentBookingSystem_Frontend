export const translations: Record<string, { vi: string; en: string }> = {
 ...
 // Footer Translation Keys
  ...
  'bookingDetail.readOnlyNotice': { vi: 'Bạn đang xem booking của người khác — chỉ có thể xem thông tin, không thể thực hiện thao tác.', en: 'Viewing another user\'s booking — view-only mode.' },
  ...
  'bookingDetail.itemsSub': { vi: 'Check-in, check-out và báo sự cố theo từng BookingItem', en: 'Check-in, check-out and report incidents per item' },
  'bookingDetail.noNote': { vi: 'Không có ghi chú.', en: 'No notes provided.' },
  'bookingDetail.overdueNoCheckin': { vi: 'Đã quá giờ, không check-in', en: 'Overdue, missed check-in' },
  'bookingDetail.notTimeYet': { vi: '(Chưa đến giờ)', en: '(Not started yet)' },
  'bookingDetail.checkInBeforeMsg': { vi: 'Chưa đến giờ check-in (Mở trước 15 phút giờ bắt đầu)', en: 'Check-in opens 15 minutes before start time' },
  'bookingDetail.checkoutByManager': { vi: 'Check-out (Quản lý check hộ)', en: 'Check-out (Manager assist)' },
  ...
  'bookingDetail.concludeSub': { vi: 'Chỉ dùng sau khi thời gian booking kết thúc và kiểm tra usage log.', en: 'Use only after booking end time and inspecting usage logs.' },
  ...
  'bookingDetail.rejectModalSub': { vi: 'Lý do sẽ được lưu và gửi thông báo cho người đặt.', en: 'Reason will be saved and notified to requester.' },
  'bookingDetail.rejectReasonLabel': { vi: 'Lý do từ chối *', en: 'Rejection Reason *' },
  'bookingDetail.rejectReasonPlaceholder': { vi: 'Nêu rõ lý do để người dùng có thể điều chỉnh...', en: 'Provide clear reason so user can adjust...' },
  ...
  'bookingDetail.incidentModalSub': { vi: 'Sự cố sẽ chờ Admin/LabManager xác nhận nếu cần.', en: 'Incident report awaits Admin/Manager confirmation if needed.' },
  'bookingDetail.incidentTypeLabel': { vi: 'Loại sự cố', en: 'Incident Type' },
  'bookingDetail.affectedEquipmentIdLabel': { vi: 'Thiết bị bị ảnh hưởng (ID)', en: 'Affected Equipment (ID)' },
  'bookingDetail.affectedEquipmentPlaceholder': { vi: 'Để trống nếu không xác định', en: 'Leave empty if unknown' },
  ...
  'bookingDetail.checkinModalTitle': { vi: 'Điểm danh vào phòng lab (Check-in)', en: 'Lab Check-in' },
  'bookingDetail.checkinModalSub': { vi: 'Nội quy: Khung giờ điểm danh từ 15 phút trước giờ bắt đầu đến 30 phút sau giờ bắt đầu.', en: 'Rule: Check-in window opens 15 mins before start until 30 mins after start.' },
  ...
  'bookingDetail.checkinRuleBody': { vi: 'Cần có mặt đúng giờ. Nếu quá 30 phút kể từ giờ bắt đầu không check-in, booking có thể bị đánh dấu No-Show và ghi nhận vi phạm.', en: 'Must be on time. If un-checked 30 mins past start, booking may be marked No-Show with violation.' },
  'bookingDetail.confirmCheckinBtn': { vi: 'Xác nhận điểm danh', en: 'Confirm Check-in' },
  'bookingDetail.checkoutModalTitle': { vi: 'Điểm danh ra khỏi phòng lab (Check-out)', en: 'Lab Check-out' },
  'bookingDetail.checkoutModalSub': { vi: 'Xác nhận trước khi kết thúc phiên sử dụng tài nguyên.', en: 'Confirm before ending resource usage session.' },
  ...
  'bookingDetail.lateNoticeTitle': { vi: 'Chú ý quy định trả phòng muộn:', en: 'Late Check-out Notice:' },
  'bookingDetail.lateNoticeBody': { vi: 'Bạn đang trễ {minutes} phút so với giờ kết thúc. Hệ thống Backend sẽ tự động ghi nhận sự cố LateCheckout và áp dụng vi phạm Trả muộn khi xác nhận.', en: 'You are {minutes} minutes late past end time. Backend will automatically record LateCheckout incident.' },
  'bookingDetail.continueUsingBtn': { vi: 'Tiếp tục sử dụng', en: 'Continue Usage' },
  'bookingDetail.confirmCheckoutBtn': { vi: 'Đăng ký hoàn tất (Checkout)', en: 'Complete Check-out' },
  ...
  'bookingForm.step2.nonContinuousNotice': { vi: 'Khung giờ không liên tục: Hệ thống sẽ tự động tạo {{count}} đơn booking riêng biệt (mỗi đơn đóng/mở check-in theo đúng giờ của khung đó).', en: 'Non-continuous time slots: System will automatically create {{count}} separate booking requests.' },
