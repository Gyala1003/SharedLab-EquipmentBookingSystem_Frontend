export const translations: Record<string, { vi: string; en: string }> = {
  ...
  'incidents.subtitle': { vi: 'Xác nhận hoặc từ chối các sự cố được báo cáo từ Nhật ký sử dụng.', en: 'Confirm or reject incidents reported from Usage Logs.' },
  ...
  'incidents.noIncidentsSub': { vi: 'Không tìm thấy báo cáo sự cố nào phù hợp với điều kiện lọc.', en: 'No incident reports match the current filter criteria.' },
  ...
  'incidents.reviewPlaceholder': { vi: 'Kết quả kiểm tra, bằng chứng hoặc hướng xử lý...', en: 'Inspection results, evidence, or action plan...' },
  'incidents.confirmWarning': { vi: 'Cảnh báo: Việc xác nhận sự cố có thể tự động ghi nhận vi phạm và điểm phạt.', en: 'Warning: Confirmed incidents may generate automatic violations and penalty points.' },

  // Manage Bookings
  'manageBookings.title': { vi: 'Quản lý Booking', en: 'Manage Bookings' },
  'manageBookings.subtitle': { vi: 'Tra cứu, theo dõi và quản lý toàn bộ vòng đời yêu cầu booking trong phạm vi quản lý.', en: 'Lookup, track, and manage booking lifecycle within management scope.' },
  'manageBookings.rejectTitle': { vi: 'Từ chối booking', en: 'Reject Booking' },
  'manageBookings.rejectSubtitle': { vi: 'Nhập lý do từ chối để người dùng biết.', en: 'Provide rejection reason for requester.' },
  'manageBookings.rejectReasonLabel': { vi: 'Lý do từ chối *', en: 'Rejection Reason *' },
  'manageBookings.rejectReasonPlaceholder': { vi: 'Khung giờ này thiết bị đang bảo trì, vui lòng chọn khung giờ khác...', en: 'The equipment is under maintenance during this period, please select another time...' },
  ...
  'bookings.mySubtitle': { vi: 'Theo dõi toàn bộ yêu cầu, trạng thái duyệt và các lượt sử dụng sắp diễn ra.', en: 'Track all requests, approval statuses, and upcoming lab sessions.' },
  ...
  'bookings.searchPlaceholder': { vi: 'Tìm mã BK, tài nguyên, mục đích...', en: 'Search booking code, resource, purpose...' },
  'bookings.detailTitle': { vi: 'Chi tiết Booking', en: 'Booking Details' },
  'bookings.detailSubtitle': { vi: 'Thông tin tài nguyên, lịch trình và trạng thái check-in', en: 'Resource details, schedule, and check-in status' },
  ...
  'labs.unavailable': { vi: 'Tạm không khả dụng', en: 'Unavailable' },
  'labs.inactive': { vi: 'Ngừng hoạt động', en: 'Inactive' },
  ...
  'home.exportCalendar': { vi: 'Xuất lịch đặt ra lịch bên ngoài', en: 'Export schedule to external calendar' },
  'home.colorLegend': { vi: 'Chú giải màu sắc & loại booking:', en: 'Color & booking type legend:' },
  ...
  'Phòng Thực hành Mạng và Hạ tầng': { vi: 'Phòng Thực hành Mạng và Hạ tầng', en: 'Network & Infrastructure Lab' },
  'Phòng Thí nghiệm Điện tử và Viễn thông': { vi: 'Phòng Thí nghiệm Điện tử và Viễn thông', en: 'Electronics & Telecom Lab' },
  ...
  'Phòng Robot và Tự động hóa': { vi: 'Phòng Robot và Tự động hóa', en: 'Robotics & Automation Lab' },
  'Phòng AI và Khoa học dữ liệu': { vi: 'Phòng AI và Khoa học dữ liệu', en: 'AI & Data Science Lab' },
  'Phòng IoT và Hệ thống nhúng': { vi: 'Phòng IoT và Hệ thống nhúng', en: 'IoT & Embedded Systems Lab' },
  ...
  'bookingForm.step2.slotUnderMaintenance': { vi: 'Đã có lịch bảo trì (Không thể đặt)', en: 'Under Maintenance (Locked)' },
  'systemMaintenance.subtitle': { vi: 'Bật/Tắt chế độ bảo trì toàn hệ thống và đặt thời gian dự kiến hoàn thành.', en: 'Toggle system-wide maintenance mode and set estimated completion schedule.' },
  ...
  'systemMaintenance.normalOperation': { vi: 'Toàn bộ dịch vụ sẵn sàng', en: 'All Services Operational' },
  'systemMaintenance.activeImpactNotice': { vi: 'Người dùng Requester và Manager đang được tự động chuyển hướng đến trang thông báo bảo trì.', en: 'Requester and Manager users are automatically redirected to the maintenance notice page.' },
  'systemMaintenance.inactiveNotice': { vi: 'Người dùng có thể truy cập hệ thống mượn phòng & thiết bị bình thường.', en: 'Users can access the lab and equipment booking system normally.' },
  ...
  'systemMaintenance.formHeader': { vi: 'Cấu hình & Đặt lịch bảo trì hệ thống', en: 'Configure System Maintenance Schedule' },
  'systemMaintenance.formSub': { vi: 'Đặt tiêu đề, thời gian bắt đầu, thời gian dự kiến hoàn thành và mô tả chi tiết.', en: 'Set title, start time, estimated completion time, and detailed scope.' },
  'systemMaintenance.fieldTitle': { vi: 'Tiêu đề thông báo (Tiếng Việt)', en: 'Notice Title (Vietnamese)' },
  'systemMaintenance.fieldTitleEn': { vi: 'Tiêu đề thông báo (Tiếng Anh)', en: 'Notice Title (English)' },
  'systemMaintenance.startTime': { vi: 'Thời gian bắt đầu bảo trì', en: 'Maintenance Start Time' },
  'systemMaintenance.endTime': { vi: 'Thời gian dự kiến hoàn thành', en: 'Estimated Completion Time' },
  'systemMaintenance.description': { vi: 'Mô tả & Phạm vi ảnh hưởng (Tiếng Việt)', en: 'Scope & Description (Vietnamese)' },
  'systemMaintenance.descriptionEn': { vi: 'Mô tả & Phạm vi ảnh hưởng (Tiếng Anh)', en: 'Scope & Description (English)' },
  'systemMaintenance.activateImmediately': { vi: 'Kích hoạt chế độ bảo trì ngay khi lưu', en: 'Enable maintenance mode immediately upon saving' },
  'systemMaintenance.saveBtn': { vi: 'Lưu lịch bảo trì', en: 'Save Maintenance Schedule' },
  'systemMaintenance.presetsTitle': { vi: 'Lịch bảo trì nhanh (Presets)', en: 'Quick Maintenance Presets' },
  'systemMaintenance.presetsSub': { vi: 'Áp dụng nhanh các khoảng thời gian bảo trì phổ biến.', en: 'Quickly apply common maintenance time windows.' },
  ...
  'systemMaintenance.overnightPreset': { vi: 'Bảo trì đêm (22h - 06h)', en: 'Overnight (22:00 - 06:00)' },
  'systemMaintenance.adminRulesTitle': { vi: 'Quy tắc hoạt động Admin', en: 'Admin Operation Rules' },
  'systemMaintenance.adminRule1': { vi: 'Tài khoản Admin có quyền bỏ qua bảo trì để thực hiện công việc quản trị.', en: 'Admin accounts bypass maintenance restriction to perform administrative tasks.' },
  'systemMaintenance.adminRule2': { vi: 'Khi kích hoạt, mọi phiên làm việc của Requester và Manager sẽ tự động trỏ về trang thông báo bảo trì.', en: 'When active, all Requester and Manager sessions are automatically routed to the maintenance page.' },
  'systemMaintenance.adminRule3': { vi: 'Hệ thống tự động hiển thị đếm ngược thời gian hoàn thành theo cấu hình.', en: 'System automatically displays countdown timer based on estimated end time.' },
  ...
  //auth
  'auth.validation.emailRequired': { vi: 'Vui lòng nhập email', en: 'Please enter your email' },
  'auth.validation.emailInvalid': { vi: 'Email không đúng định dạng', en: 'Invalid email format' },
  'auth.validation.passwordRequired': { vi: 'Vui lòng nhập mật khẩu', en: 'Please enter your password' },
  'auth.validation.passwordMinLength': { vi: 'Mật khẩu phải nhiều hơn 5 ký tự', en: 'Password must be more than 5 characters' },
  'auth.error.invalidCredentials': { vi: 'Email hoặc mật khẩu không chính xác.', en: 'Invalid email or password.' },
  'auth.error.serverError': { vi: 'Hệ thống đang gặp sự cố. Vui lòng thử lại sau.', en: 'System error. Please try again later.' },
  'auth.error.tooManyRequests': { vi: 'Bạn thao tác quá nhanh, vui lòng thử lại sau', en: 'Too many requests. Please try again later' },
  'auth.error.invalidToken': { vi: 'Liên kết đặt lại mật khẩu không hợp lệ hoặc đã hết hạn.', en: 'Password reset link is invalid or has expired.' },
  'auth.error.passwordMismatch': { vi: 'Mật khẩu xác nhận không trùng khớp', en: 'Confirm password does not match' },
  'auth.error.required': { vi: 'Trường này không được để trống', en: 'This field is required' },
  'auth.loginTitle': { vi: 'Đăng nhập', en: 'Sign In' },
  'auth.loginSubtitle': { vi: 'Vui lòng đăng nhập để sử dụng hệ thống', en: 'Please log in to use the system' },
  ...
  'auth.invalidLink': { vi: 'Liên kết không hợp lệ hoặc thiếu thông tin xác thực', en: 'Invalid or missing verification link parameters' },
  'auth.passwordPolicyHint': { vi: 'Mật khẩu phải dài tối thiểu 8 ký tự, gồm chữ hoa, chữ thường, chữ số và ký tự đặc biệt', en: 'Password must be at least 8 characters, with uppercase, lowercase, number, and special character' },
  ...
  'auth.passwordRules.lowercase': { vi: 'Có ít nhất 1 chữ thường', en: 'At least 1 lowercase letter' },
  'auth.passwordRules.digit': { vi: 'Có ít nhất 1 chữ số', en: 'At least 1 number' },
  'auth.passwordRules.special': { vi: 'Có ít nhất 1 ký tự đặc biệt (@$!%*?&...)', en: 'At least 1 special character (@$!%*?&...)' },
  'auth.success.login': { vi: 'Đăng nhập thành công! Đang chuyển hướng...', en: 'Login successful! Redirecting...' },
  'auth.success.resetEmailSent': { vi: 'Đã gửi liên kết đặt lại mật khẩu! Vui lòng kiểm tra hộp thư email của bạn.', en: 'Password reset link sent! Please check your email inbox.' },
  'auth.success.resetPassword': { vi: 'Đổi mật khẩu thành công! Đang chuyển hướng về trang đăng nhập...', en: 'Password changed successfully! Redirecting to login page...' },
  ...
  'bookingForm.subtitle': { vi: 'Quy trình 4 bước giúp chọn đúng tài nguyên, thời gian và mức ưu tiên trước khi gửi duyệt.', en: '4-step process to select resources, schedule, and priority level before submission.' },
  'bookingForm.checkCalendar': { vi: 'Kiểm tra lịch', en: 'Check Schedule' },
  'bookingForm.accountStatusRestrictedTitle': { vi: 'Tài khoản hiện không thể tạo booking', en: 'Account currently restricted from creating bookings' },
  'bookingForm.accountStatusRestrictedMsg': { vi: 'Trạng thái hiện tại: {{status}}. Liên hệ quản trị viên hoặc chờ hết thời gian hạn chế.', en: 'Current status: {{status}}. Please contact admin or wait until restriction expires.' },
  ...
  'bookingForm.step1.subtitle': { vi: 'Một booking chỉ được chứa tài nguyên thuộc cùng một phòng lab.', en: 'A booking can only contain resources belonging to the same lab.' },
  ...
  'bookingForm.step1.capacity': { vi: 'Sức chứa: {{count}} người', en: 'Capacity: {{count}} people' },
  'bookingForm.step1.addEquipmentTitle': { vi: 'Đặt thêm thiết bị trong phòng này', en: 'Book additional equipment in this room' },
  'bookingForm.step1.addEquipmentSubtitle': { vi: 'Tuỳ chọn — chọn thiết bị đang trống muốn book kèm', en: 'Optional — select available equipment to include' },
  'bookingForm.step1.equipmentsInLab': { vi: 'Thiết bị trong {{name}}', en: 'Equipment in {{name}}' },
  ...
  'bookingForm.step1.bookEntireLabSub': { vi: 'Sử dụng toàn bộ không gian', en: 'Utilize the whole room space' },
  'bookingForm.step1.bookEquipment': { vi: 'Đặt thiết bị', en: 'Book Equipment' },
  'bookingForm.step1.bookEquipmentSub': { vi: 'Có thể chọn nhiều thiết bị', en: 'Select one or multiple items' },
  ...
  'bookingForm.step1.roomNotePlaceholder': { vi: 'Yêu cầu bố trí, lưu ý khi sử dụng...', en: 'Seating arrangements, special usage notes...' },
  ...
  'bookingForm.step2.subtitle': { vi: 'Thời gian được chia làm 4 slot cố định trong ngày. Tối đa 2 lần đặt / ngày.', en: '4 fixed time slots per day. Maximum 2 bookings per person per day.' },
  ...
  'bookingForm.step2.waitlistRestriction': { vi: 'Hàng chờ hiện chỉ nhận một phòng hoặc một thiết bị mỗi lượt. Hãy giữ lại một thiết bị nếu muốn tham gia.', en: 'Waitlist accepts only one room or one equipment per request. Keep a single item selected to join.' },
  'bookingForm.step2.suggestionsTitle': { vi: 'Khung giờ thay thế', en: 'Alternative Time Slots' },
  'bookingForm.step2.to': { vi: 'đến', en: 'to' },
  'bookingForm.step2.userQuota': { vi: 'Lượt đặt hôm nay: {current}/{max}', en: 'Your bookings today: {current}/{max}' },
  'bookingForm.step2.userLimitReached': { vi: 'Bạn đã đạt giới hạn tối đa 2 lượt đặt phòng/thiết bị trong ngày này.', en: 'You have reached the maximum limit of 2 bookings for this date.' },
  'bookingForm.step2.dayEventsTitle': { vi: 'Lịch đã đặt trong ngày', en: 'Schedule for Selected Date' },
  'bookingForm.step2.eventsCount': { vi: 'sự kiện', en: 'events' },
  'bookingForm.step2.loadingSchedule': { vi: 'Đang tải lịch trong ngày...', en: 'Loading schedule...' },
  'bookingForm.step2.noEventsToday': { vi: 'Ngày này chưa có lịch đặt nào', en: 'No bookings on this date yet' },
  'bookingForm.step2.allSlotsFree': { vi: 'Tất cả 4 slot đều đang trống và sẵn sàng.', en: 'All 4 time slots are available.' },
  'bookingForm.step2.bookedBy': { vi: 'Người đặt', en: 'Booked by' },
  'bookingForm.step2.selectSlotTitle': { vi: 'Chọn Slot thời gian (Tối đa 2 slot/ngày)', en: 'Select Time Slot (Max 2 slots/day)' },
  ...
  'bookingForm.step2.slotUserConflict': { vi: 'Đã có người đặt (Lịch cá nhân bị trùng #BK-{id})', en: 'Already Booked (Personal schedule conflict #BK-{id})' },
  'bookingForm.step2.slotLimitReached': { vi: 'Đã có người đặt (Đã đạt giới hạn 2 lượt đặt/ngày)', en: 'Already Booked (Daily limit reached)' },
  'bookingForm.step2.slotPastTime': { vi: 'Đã có người đặt (Khung giờ đã qua)', en: 'Already Booked (Time slot has passed)' },
  'bookingForm.step2.personalSchedule': { vi: 'Lịch đặt cá nhân', en: 'Personal Schedule' },
  'bookingForm.step2.cannotSelectSlot': { vi: 'Không thể chọn khung giờ này', en: 'Cannot select this time slot' },
  'bookingForm.step2.underMaintenanceMsg': { vi: 'đang trong thời gian bảo trì.', en: 'is currently under maintenance.' },
  'bookingForm.step2.conflictTitle': { vi: 'Lịch cá nhân bị trùng', en: 'Personal Schedule Conflict' },
  'bookingForm.step2.conflictMsg': { vi: 'Bạn đã có 1 lịch đặt khác', en: 'You already have another booking' },
  'bookingForm.step2.pastTimeTitle': { vi: 'Khung giờ đã trôi qua', en: 'Time Slot Has Passed' },
  'bookingForm.step2.pastTimeMsg': { vi: 'đã trôi qua so với thời gian hiện tại.', en: 'has already elapsed.' },
  'bookingForm.step2.limitReachedTitle': { vi: 'Đã đạt giới hạn đặt phòng', en: 'Daily Limit Reached' },
  'bookingForm.step2.limitReachedMsg': { vi: 'Bạn đã đạt giới hạn tối đa 2 lượt đặt phòng/ngày (2/2) trên toàn hệ thống phòng lab.', en: 'You have reached the maximum limit of 2 bookings per day across all lab rooms.' },
  'bookingForm.step2.slotOccupiedTitle': { vi: 'Khung giờ đã có người đặt', en: 'Time Slot Already Booked' },
  'bookingForm.step2.slotOccupiedMsg': { vi: 'đã được sử dụng bởi người dùng khác.', en: 'is already taken by another user.' },
  'bookingForm.step2.maxQuotaReached': { vi: 'Đã đạt giới hạn lượt đặt', en: 'Daily quota limit reached' },
  ...
  'bookingForm.step3.subtitle': { vi: 'Mức ưu tiên được đọc từ quy tắc đang Active trong backend.', en: 'Priority level is determined by active system rules.' },
  'bookingForm.step3.descLabel': { vi: 'Mô tả mục đích *', en: 'Purpose Description *' },
  'bookingForm.step3.descPlaceholder': { vi: 'Mô tả nội dung thực hành, dự án, số người tham gia và kết quả mong đợi...', en: 'Describe lab work content, project scope, participant count, and expected outcomes...' },
  ...
  'bookingForm.purposes.research.desc': { vi: 'Nghiên cứu khoa học, đề tài hoặc dự án.', en: 'Scientific research, thesis, or project work.' },
  'bookingForm.purposes.course.label': { vi: 'Thực hành môn học', en: 'Course Practice' },
  'bookingForm.purposes.course.desc': { vi: 'Buổi thực hành theo kế hoạch môn học.', en: 'Practical lab session according to course syllabus.' },
  'bookingForm.purposes.selfStudy.label': { vi: 'Tự học', en: 'Self Study' },
  'bookingForm.purposes.selfStudy.desc': { vi: 'Tự nghiên cứu hoặc luyện tập cá nhân.', en: 'Independent research or personal practice.' },
  'bookingForm.purposes.other.label': { vi: 'Mục đích khác', en: 'Other Purpose' },
  'bookingForm.purposes.other.desc': { vi: 'Các nhu cầu hợp lệ ngoài ba nhóm trên.', en: 'Other valid activities outside the above categories.' },

  'bookingForm.step4.title': { vi: 'Xác nhận yêu cầu', en: 'Confirm Request' },
  'bookingForm.step4.subtitle': { vi: 'Kiểm tra lần cuối trước khi gửi booking ở trạng thái Pending.', en: 'Review your details before submitting as Pending booking.' },
  'bookingForm.step4.timeLabel': { vi: 'Thời gian', en: 'Schedule' },
  'bookingForm.step4.purposeLabel': { vi: 'Mục đích', en: 'Purpose' },
  'bookingForm.step4.priorityLevel': { vi: 'Mức ưu tiên P{{level}}', en: 'Priority Level P{{level}}' },
  ...
  'bookingForm.sidebar.tipBody': { vi: 'Kiểm tra lịch trước khi gửi. Pending không khóa tài nguyên; booking chỉ khóa slot sau khi được duyệt.', en: 'Check schedule before submitting. Pending status does not lock resources; slot is reserved once approved.' },
  ...
  'lab.notFoundMsg': { vi: 'Phòng lab có thể đã bị xóa hoặc bạn không có quyền truy cập.', en: 'The lab room may have been deleted or you do not have access.' },
  ...
  'lab.noDescription': { vi: 'Chưa có mô tả cho phòng lab này.', en: 'No description available for this lab.' },
  'lab.usageGuideline': { vi: 'Hướng dẫn sử dụng', en: 'Usage Guidelines' },
  'lab.defaultGuideline': { vi: 'Liên hệ LabManager để được hướng dẫn trước khi sử dụng.', en: 'Contact LabManager for guidelines before use.' },
  ...
  'lab.emptyEquipmentMsg': { vi: 'Admin có thể bổ sung thiết bị từ màn hình quản lý thiết bị.', en: 'Admin can add equipment from the equipment management screen.' },
  'lab.emptyScheduleTitle': { vi: 'Không có lịch trong 30 ngày tới', en: 'No schedule for the next 30 days' },
  'lab.emptyScheduleMsg': { vi: 'Phòng hiện chưa có booking hoặc bảo trì trong khoảng thời gian này.', en: 'The lab currently has no bookings or maintenance in this period.' },
  'lab.emptyMaintenanceTitle': { vi: 'Chưa có lịch bảo trì', en: 'No maintenance history' },
  'lab.emptyMaintenanceMsg': { vi: 'Không có lịch bảo trì trực tiếp hoặc thiết bị thuộc phòng trong dữ liệu hiện tại.', en: 'No maintenance records found for this lab or its equipment.' },
  ...
  'equipment.notFoundMsg': { vi: 'Thiết bị có thể đã ngừng sử dụng hoặc không tồn tại.', en: 'Equipment may be inactive or does not exist.' },
  ...
  'equipment.noSpecs': { vi: 'Chưa cập nhật thông số kỹ thuật.', en: 'Technical specs not updated yet.' },
  'equipment.usageGuideline': { vi: 'Hướng dẫn sử dụng', en: 'Usage Guidelines' },
  'equipment.defaultGuideline': { vi: 'Liên hệ LabManager để được hướng dẫn.', en: 'Contact LabManager for guidelines.' },
  'equipment.next30Days': { vi: 'Lịch 30 ngày tới', en: 'Schedule for Next 30 Days' },
  'equipment.scheduleSubtitle': { vi: 'Booking và bảo trì của thiết bị', en: 'Equipment bookings & maintenance' },
  'equipment.fullRoomLock': { vi: 'Khóa do Đặt cả phòng', en: 'Locked by Full Room Booking' },
  'equipment.specificEquipLock': { vi: 'Đặt riêng thiết bị này', en: 'Specific Equipment Booking' },
  'equipment.viewAll': { vi: 'Xem toàn bộ', en: 'View all' },
  'equipment.emptyScheduleTitle': { vi: 'Lịch đang trống', en: 'Schedule is empty' },
  'equipment.emptyScheduleMsg': { vi: 'Thiết bị chưa có sự kiện trong 30 ngày tới.', en: 'No events scheduled for this equipment in the next 30 days.' },
  'equipment.maintenanceHistory': { vi: 'Lịch sử bảo trì', en: 'Maintenance History' },
  'equipment.maintenanceHistorySub': { vi: 'Các lịch bảo trì gắn với thiết bị', en: 'Maintenance records linked to this equipment' },
  'equipment.emptyMaintenanceTitle': { vi: 'Chưa có lịch bảo trì', en: 'No maintenance history' },
  'equipment.emptyMaintenanceMsg': { vi: 'Thiết bị chưa có bản ghi bảo trì.', en: 'No maintenance records found for this equipment.' },
  ...
  'Phòng đo kiểm mạch điện, tín hiệu và linh kiện điện tử.': { vi: 'Phòng đo kiểm mạch điện, tín hiệu và linh kiện điện tử.', en: 'Room for testing electronic circuits, signals, and components.' },
  'Tắt nguồn thiết bị sau khi sử dụng; báo ngay khi có sự cố.': { vi: 'Tắt nguồn thiết bị sau khi sử dụng; báo ngay khi có sự cố.', en: 'Turn off power after use; report immediately in case of issues.' },
  'Kính hiển vi quang học hai mắt, độ phóng đại tối đa 1000x': { vi: 'Kính hiển vi quang học hai mắt, độ phóng đại tối đa 1000x', en: 'Binocular optical microscope, maximum magnification 1000x' },
  'Lau vật kính bằng giấy chuyên dụng sau khi sử dụng.': { vi: 'Lau vật kính bằng giấy chuyên dụng sau khi sử dụng.', en: 'Wipe objective lens with dedicated lens paper after use.' },
  'Chưa có hạng mục chính sách nào.': { vi: 'Chưa có hạng mục chính sách nào.', en: 'No policy categories available.' },
  'Chưa có hành vi nào trong hạng mục này.': { vi: 'Chưa có hành vi nào trong hạng mục này.', en: 'No items in this category.' },

  // Equipment specs & guidelines dynamic translations
  'Bộ lưu điện bảo vệ workstation': { vi: 'Bộ lưu điện bảo vệ workstation', en: 'Workstation protection UPS' },
  'Bo mạch Arduino tích hợp Wi-Fi': { vi: 'Bo mạch Arduino tích hợp Wi-Fi', en: 'Wi-Fi enabled Arduino board' },
