export const translations: Record<string, { vi: string; en: string }> = {
  ...
  'lab.qrCheckinHeader': { vi: 'Điểm danh nhanh bằng QR', en: 'Quick QR Check-in' },
  'lab.qrCheckinTitle': { vi: 'Quét mã để vào phòng', en: 'Scan QR code to enter room' },
  'lab.qrCheckinMsg': { vi: 'In mã này dán tại cửa phòng lab, người dùng quét bằng camera điện thoại sẽ được đưa thẳng vào trang Chi tiết booking để điểm danh.', en: 'Print and stick this QR at the lab door. Users scanning it with their mobile camera will open the booking details page to check in.' },
  'lab.qrNoActiveBooking': { vi: 'Bạn chưa có booking đang trong khung giờ hoạt động tại phòng này nên chưa thể tạo mã QR điểm danh.', en: 'You do not have an active booking during this time slot in this lab to generate a check-in QR code.' },
