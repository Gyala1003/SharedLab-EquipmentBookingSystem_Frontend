export const translations: Record<string, { vi: string; en: string }> = {
  ...
  'footer.address': {
    vi: 'Số 123 ABC, Phường DE, Quận FG, Hà Nội',
    en: '123 ABC Street, DE Ward, FG District, Hanoi',
  },
  ...
  // Booking Detail Page
  'bookingDetail.createdAt': { vi: 'Tạo lúc {time}', en: 'Created at {time}' },
  'bookingDetail.approveBtn': { vi: 'Duyệt', en: 'Approve' },
  'bookingDetail.rejectBtn': { vi: 'Từ chối', en: 'Reject' },
  'bookingDetail.cancelBtn': { vi: 'Hủy booking', en: 'Cancel Booking' },
  'bookingDetail.myBookingsBtn': { vi: 'Booking của tôi', en: 'My Bookings' },
  'bookingDetail.readOnlyNotice': {
    vi: 'Bạn đang xem booking của người khác — chỉ có thể xem thông tin, không thể thực hiện thao tác.',
    en: "Viewing another user's booking — view-only mode.",
  },
  'bookingDetail.currentStatus': { vi: 'TRẠNG THÁI HIỆN TẠI', en: 'CURRENT STATUS' },
  'bookingDetail.priority': { vi: 'ƯU TIÊN', en: 'PRIORITY' },
  'bookingDetail.resources': { vi: 'TÀI NGUYÊN', en: 'RESOURCES' },
  'bookingDetail.duration': { vi: 'THỜI LƯỢNG', en: 'DURATION' },
  'bookingDetail.start': { vi: 'Bắt đầu', en: 'Start Time' },
  'bookingDetail.end': { vi: 'Kết thúc', en: 'End Time' },
  'bookingDetail.purposeDesc': { vi: 'Mô tả mục đích', en: 'Purpose Description' },
  'bookingDetail.noDescription': { vi: 'Không có mô tả.', en: 'No description provided.' },
  'bookingDetail.rejectionReason': { vi: 'Lý do từ chối', en: 'Rejection Reason' },
  'bookingDetail.itemsTitle': { vi: 'Tài nguyên trong booking', en: 'Booking Resources' },
  'bookingDetail.itemsSub': {
    vi: 'Check-in, check-out và báo sự cố theo từng BookingItem',
    en: 'Check-in, check-out and report incidents per item',
  },
  'bookingDetail.noNote': { vi: 'Không có ghi chú.', en: 'No notes provided.' },
  'bookingDetail.overdueNoCheckin': {
    vi: 'Đã quá giờ, không check-in',
    en: 'Overdue, missed check-in',
  },
  'bookingDetail.notTimeYet': { vi: '(Chưa đến giờ)', en: '(Not started yet)' },
  'bookingDetail.checkInBeforeMsg': {
    vi: 'Chưa đến giờ check-in (Mở trước 15 phút giờ bắt đầu)',
    en: 'Check-in opens 15 minutes before start time',
  },
  'bookingDetail.checkoutByManager': {
    vi: 'Check-out (Quản lý check hộ)',
    en: 'Check-out (Manager assist)',
  },
  'bookingDetail.reportIncident': { vi: 'Báo sự cố', en: 'Report Incident' },
  'bookingDetail.checkedOutDone': { vi: 'Đã hoàn tất (Checked-out)', en: 'Checked-out' },
  'bookingDetail.statusLabel': { vi: 'Trạng thái', en: 'Status' },
  'bookingDetail.notCheckedOutYet': { vi: 'Chưa checkout', en: 'Not checked out' },
  'bookingDetail.incidentLabel': { vi: 'Sự cố', en: 'Incident' },
  'bookingDetail.relatedViolations': { vi: 'Vi phạm liên quan', en: 'Related Violations' },
  'bookingDetail.points': { vi: 'điểm', en: 'pts' },
  'bookingDetail.requester': { vi: 'NGƯỜI ĐẶT', en: 'REQUESTER' },
  'bookingDetail.approval': { vi: 'XÉT DUYỆT', en: 'APPROVAL' },
  'bookingDetail.approvedBy': { vi: 'Người duyệt', en: 'Approved By' },
  'bookingDetail.notApprovedYet': { vi: 'Chưa duyệt', en: 'Not approved' },
  'bookingDetail.approvedAt': { vi: 'Thời gian duyệt', en: 'Approved At' },
  'bookingDetail.concludeOps': { vi: 'Hoàn tất nghiệp vụ', en: 'Conclude Operation' },
  'bookingDetail.concludeSub': {
    vi: 'Chỉ dùng sau khi thời gian booking kết thúc và kiểm tra usage log.',
    en: 'Use only after booking end time and inspecting usage logs.',
  },
  'bookingDetail.markComplete': { vi: 'Đánh dấu hoàn thành', en: 'Mark Completed' },
  'bookingDetail.markNoShow': { vi: 'Đánh dấu NoShow', en: 'Mark NoShow' },
  'bookingDetail.rejectModalTitle': { vi: 'Từ chối booking', en: 'Reject Booking' },
  'bookingDetail.rejectModalSub': {
    vi: 'Lý do sẽ được lưu và gửi thông báo cho người đặt.',
    en: 'Reason will be saved and notified to requester.',
  },
  'bookingDetail.rejectReasonLabel': { vi: 'Lý do từ chối *', en: 'Rejection Reason *' },
  'bookingDetail.rejectReasonPlaceholder': {
    vi: 'Nêu rõ lý do để người dùng có thể điều chỉnh...',
    en: 'Provide clear reason so user can adjust...',
  },
  'bookingDetail.confirmReject': { vi: 'Xác nhận từ chối', en: 'Confirm Rejection' },
  'bookingDetail.incidentModalTitle': { vi: 'Báo sự cố sử dụng', en: 'Report Usage Incident' },
  'bookingDetail.incidentModalSub': {
    vi: 'Sự cố sẽ chờ Admin/LabManager xác nhận nếu cần.',
    en: 'Incident report awaits Admin/Manager confirmation if needed.',
  },
  'bookingDetail.incidentTypeLabel': { vi: 'Loại sự cố', en: 'Incident Type' },
  'bookingDetail.affectedEquipmentIdLabel': {
    vi: 'Thiết bị bị ảnh hưởng (ID)',
    en: 'Affected Equipment (ID)',
  },
  'bookingDetail.affectedEquipmentPlaceholder': {
    vi: 'Để trống nếu không xác định',
    en: 'Leave empty if unknown',
  },
  'bookingDetail.detailDescLabel': { vi: 'Mô tả chi tiết', en: 'Detailed Description' },
  'bookingDetail.sendReportBtn': { vi: 'Gửi báo cáo', en: 'Send Report' },
  'bookingDetail.checkinModalTitle': {
    vi: 'Điểm danh vào phòng lab (Check-in)',
    en: 'Lab Check-in',
  },
  'bookingDetail.checkinModalSub': {
    vi: 'Nội quy: Khung giờ điểm danh từ 15 phút trước giờ bắt đầu đến 30 phút sau giờ bắt đầu.',
    en: 'Rule: Check-in window opens 15 mins before start until 30 mins after start.',
  },
  'bookingDetail.checkinPerson': { vi: 'Người điểm danh', en: 'Check-in User' },
  'bookingDetail.account': { vi: 'Tài khoản', en: 'Account' },
  'bookingDetail.department': { vi: 'Khoa/phòng ban', en: 'Department' },
  'bookingDetail.labOrResource': { vi: 'Phòng lab / tài nguyên', en: 'Lab / Resource' },
  'bookingDetail.checkinTimestamp': { vi: 'Thời điểm điểm danh', en: 'Check-in Time' },
  'bookingDetail.checkinRuleTitle': { vi: 'Quy định điểm danh:', en: 'Check-in Rules:' },
  'bookingDetail.checkinRuleBody': {
    vi: 'Cần có mặt đúng giờ. Nếu quá 30 phút kể từ giờ bắt đầu không check-in, booking có thể bị đánh dấu No-Show và ghi nhận vi phạm.',
    en: 'Must be on time. If un-checked 30 mins past start, booking may be marked No-Show with violation.',
  },
  'bookingDetail.confirmCheckinBtn': { vi: 'Xác nhận điểm danh', en: 'Confirm Check-in' },
  'bookingDetail.checkoutModalTitle': {
    vi: 'Điểm danh ra khỏi phòng lab (Check-out)',
    en: 'Lab Check-out',
  },
  'bookingDetail.checkoutModalSub': {
    vi: 'Xác nhận trước khi kết thúc phiên sử dụng tài nguyên.',
    en: 'Confirm before ending resource usage session.',
  },
  'bookingDetail.user': { vi: 'Người dùng', en: 'User' },
  'bookingDetail.checkinTime': { vi: 'Giờ check-in', en: 'Check-in Time' },
  'bookingDetail.registeredEndTime': { vi: 'Giờ kết thúc đăng ký', en: 'Scheduled End Time' },
  'bookingDetail.lateNoticeTitle': {
    vi: 'Chú ý quy định trả phòng muộn:',
    en: 'Late Check-out Notice:',
  },
  'bookingDetail.lateNoticeBody': {
    vi: 'Bạn đang trễ {minutes} phút so với giờ kết thúc. Hệ thống Backend sẽ tự động ghi nhận sự cố LateCheckout và áp dụng vi phạm Trả muộn khi xác nhận.',
    en: 'You are {minutes} minutes late past end time. Backend will automatically record LateCheckout incident.',
  },
  'bookingDetail.continueUsingBtn': { vi: 'Tiếp tục sử dụng', en: 'Continue Usage' },
  'bookingDetail.confirmCheckoutBtn': {
    vi: 'Đăng ký hoàn tất (Checkout)',
    en: 'Complete Check-out',
  },
  ...
  // Maintenance Detail
  'maintenanceDetail.titlePrefix': { vi: 'Bảo trì', en: 'Maintenance' },
  ...
  'auth.emailOrUsername': { vi: 'Email hoặc Username', en: 'Email or Username' },
  ...
  'bookingForm.step1.equipmentsInLabTitle': {
    vi: 'Danh sách thiết bị đi kèm',
    en: 'Included Equipment List',
  },
  'bookingForm.step1.equipmentsInLabSubtitle': {
    vi: 'Danh sách thiết bị thuộc {name}. Tích chọn thiết bị nếu bạn có nhu cầu sử dụng.',
    en: 'Available equipment in {name}. Select the equipment you wish to use.',
  },
  ...
  'bookingForm.step2.nonContinuousNotice': {
    vi: 'Khung giờ không liên tục: Hệ thống sẽ tự động tạo {{count}} đơn booking riêng biệt (mỗi đơn đóng/mở check-in theo đúng giờ của khung đó).',
    en: 'Non-continuous time slots: System will automatically create {{count}} separate booking requests.',
  },
