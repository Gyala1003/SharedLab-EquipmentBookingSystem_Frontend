            ...
            >
              ...
              <div class="relative">
                <div class="flex items-center gap-4">
                  <div
                    class="flex h-20 w-20 items-center justify-center rounded-[24px] bg-gradient-to-br from-violet-400 to-cyan-300 text-2xl font-black text-[#111a3a] shadow-xl"
                  >
...
export class UserDetailPage implements OnInit {
  ...
  private load(showLoading = true): void {
    ...
    forkJoin({
      ...
      penalty: this.api.userPenalty(this.userId),
      summary: this.api.violationSummary(this.userId),
