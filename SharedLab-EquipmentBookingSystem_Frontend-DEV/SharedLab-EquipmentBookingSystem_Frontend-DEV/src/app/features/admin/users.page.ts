    ...
    <section class="space-y-6">
      ...
      <article class="card-surface space-y-4 p-5">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div>
            <a routerLink="/app/admin/users/new" class="btn-primary flex items-center gap-2"
        ...
        <div class="border-t border-slate-100 pt-3">
          ...
          <div class="flex scrollbar-none items-center gap-2 overflow-x-auto pt-0.5 pb-1">
            ...
            >
              <span
                class="flex h-5 w-5 shrink-0 items-center justify-center rounded-lg bg-cyan-100 text-[11px] text-cyan-700"
            ...
            >
              <span
                class="flex h-5 w-5 shrink-0 items-center justify-center rounded-lg bg-rose-100 text-[11px] text-rose-700"
                ><app-icon name="alert" [size]="12"
              /></span>
              <span class="text-xs font-bold text-slate-600"
                >{{ 'users.totalPenalties' | t }}:</span
              >
